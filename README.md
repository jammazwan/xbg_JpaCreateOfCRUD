...
Functionality: **_JPA - Create of CRUD_**
...
Git clone the xbg_JpaCreateOfCRUD project into your workspace:

_from your bash shell:_

```bash
cd yourworkspacedirectory
git clone https://github.com/jammazwan/xbg_JpaCreateOfCRUD.git
cd xbg_JpaCreateOfCRUD
mvn install -DskipTests

```

You man now import xbg_JpaCreateOfCRUD into your IDE.
...
_Run XbgTest, also see NOTES.md_
